...
<div class="row">
    <div class="col-md-4">
        <div class="form-group">
            ...
            <select name="cond_overall" id="cond_overall"
                class="form-control @error('cond_overall') is-invalid @enderror" required>
    ...
    <div class="col-md-4">
        <div class="form-group">
            <div class="custom-control custom-switch mt-4">
                ...
                <input type="checkbox" class="custom-control-input" id="ada_temuan_kerusakan"
                    name="ada_temuan_kerusakan" value="1" {{ $temuan ? 'checked' : '' }}>
    ...
    <div class="col-md-8">
        <div class="form-group">
            ...
            <textarea name="catatan" id="catatan" rows="3"
                style="min-height:20px !important; height:auto !important; box-sizing:border-box;"
                class="form-control @error('catatan') is-invalid @enderror" placeholder="Opsional">{{ old('catatan', $editing ? $report->catatan : '') }}</textarea>
            @error('catatan')
                <div class="invalid-feedback">{{ $message }}</div>
            @enderror
        </div>
